###############################################################################
#                                                                             #
#                        Generate list of SNPs for                            #
#                    SNP-outcome association extraction                       #
#                                                                             #
###############################################################################
...
# Save a list of all exposure SNPs and potential proxies which should be
# extracted as rsid_all.txt; SNP-outcome associations will be extracted next

all_snps_to_extract <- unique(all_snps)

write(all_snps_to_extract, file.path(home_dir, "data/exposure_dat/rsid_all.txt"))
