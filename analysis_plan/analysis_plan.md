...
Further sensitivity analyses will be conducted to assess pleiotropic effects specific to this study. First, instruments within the MHC region (genome build 37) will be excluded, since this region is highly pleiotropic with a complex long-range LD structure. Additionally, MR estimates will be replicated using a maternal SNP-outcome GWAS adjusted for fetal genotype, to assess robustness of effects to confounding by direct genetic transmission.
